...
{
    LOGD_AIO("%s:%s => gen_helper_outx, ot=%d, v=%d, n=%d=>%d\n", __FILE__, __func__, ot, v, n, n & 0xff);
    switch (ot) {
...
static inline void gen_outs(DisasContext *s, int ot)
{
    ...
    if((cpu_tmp3_i32 & 0xff) == 48)
           LOGD_AIO("%s:%s => gen_helper_out_func, ot=%d, cpu_tmp2_i32=%d, n=%d=>%d\n", __FILE__, __func__, ot, cpu_tmp3_i32, cpu_tmp3_i32 & 0xff);
